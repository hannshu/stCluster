...
.. note:: 
   Please note that although we use all methods to make stCluster reproducible, the results of stCluster on your device may still significantly differ from what is reported in our paper due to the differences in hardware. To fully reproduce the results as described in the paper, it is recommended to use the container we have provided on a Nvidia RTX 3090 GPU device
